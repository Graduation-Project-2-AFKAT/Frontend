...
const GameCard = ({ username, className }: IProps) => {
  return (
    <div
      className={`outline-primary m-5 bg-[#2A2731] shadow-md drop-shadow-md duration-50 md:rounded-lg lg:hover:outline-2 lg:hover:outline-dashed ${className}`}
    >
      <div className="flex h-full flex-col justify-between">
        <img
          src="https://m.gjcdn.net/game-thumbnail/400/366063-h97avijq-v4.webp"
          alt=""
          className="h-[60%] rounded-xl object-fill" //TODO object-cover
        />
