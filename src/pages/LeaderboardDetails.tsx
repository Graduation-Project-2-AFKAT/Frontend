...
import { loadLeaderboardEntriesById } from "../redux/modules/leaderboards";
...
const LeaderboardDetails = () => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(loadLeaderboardEntriesById(id));
    }
  }, [id, dispatch]);
  ...
  return (
    <main className="h-full w-full overflow-y-auto">
      <div className="mx-auto max-w-6xl px-[8%] pt-8 pb-16 md:px-[5%]">
        ...
        <h1 className="mb-6 text-3xl font-bold">Leaderboard Details</h1>
